...
if ($profile_complete != '') {
    ...
    <div class="notification alert alert-default">
        ...
        <div class="col-sm-11">
            <p>
                <span class="normalAsh">Por favor, insira seu <?php echo $profile_complete; ?></span>
            </p>
                        ...
                        <p>
                            <b>
                                <a href="<?php echo base_url() . 'user/view/' . $user_news[$x]['user_name']; ?>"><?php echo $user_news[$x]['user_name']; ?></a>
                                    ...
                                    <span class="normalAsh">
                                        <?php echo $user_news[$x]['status']; ?> um pagamento de <b>$<?php echo number_format((float)$user_news[$x]['amount'], 2, '.', ''); ?></b> for
                                    </span>
