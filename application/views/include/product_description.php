                ...
                <div class="activityInfo text-center">
                    <p class="activityIndex">Orçamento<br>
                        <?php if ($product_data->budget_type == 'fixed') { ?>
                            <b class="text-blue text-large">R$<?php echo number_format((float)$product_data->fixed_budget, 2, '.', ''); ?></b>
                        <?php } else { ?>
                            <b class="text-blue text-large">R$<?php echo number_format((float)$product_data->min_budget, 2, '.', '') . ' - $' . number_format((float)$product_data->max_budget, 2, '.', ''); ?></b>
                        <?php } ?>
                    </p>
                </div>
            </div>
