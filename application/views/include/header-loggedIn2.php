                    ...
                    <div class="pull-right">
                        <div class="messagesNotify pull-right">
                            ...
                            <div class="msgNitification dropdown-menu" role="menu">
                                <p class="notifyHeader">Mensagens</p>
                                                            ...
                                                            <div class="col-md-11">
                                                                <p>
                                                                    ...
                                                                    <span class="normalAsh">
                                                                        enviou <b><?php echo $message['count']; ?></b> <?php echo $message['count'] > 1 ? 'mensagens' : 'mensagem'; ?>
                                                                        à você.
                                                                    </span>
                                                                </p>
                                                            </div>
                                ...
                                <div class="msgBoxLink">
                                    <?php if ($messages['0'] == 0) {
                                        ?>
                                        <p class="text-center text-primary noMsg">Sem novas mensagens</p>
                                    <?php } else {
                                        ?>
                                        <a class="text-center seeAllNotification" href="<?php echo base_url() ?>messages/">Ver todas</a>
                                    <?php } ?>
                                </div>
                            </div>
                        </div>
