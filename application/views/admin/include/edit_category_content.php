...
<div class="row">
    <div class="col-md-7 col-md-offset-1">
        <div class="form_content">
            <form class="form-horizontal" role="form" action="<?php echo base_url() ?>admin/category/edit/<?php echo $cat_id; ?>" method="post">
                ...
                <div class="form-group <?php echo form_error("category") ? 'has-error' : ''; ?>">
                    ...
                    <div class="col-sm-9">
                        <input name="category" value="<?php echo $category->cat_name; ?>" type="text"
                               class="form-control" id="category" placeholder="Nome">
                ...
                <div class="form-group <?php echo form_error("url") ? 'has-error' : ''; ?>">
                    ...
                    <div class="col-sm-9">
                        <input name="url" value="<?php echo $category->url; ?>" type="text"
                ...
                <div class="form-group">
                    <div class="form-action">
                        <button onclick="window.location.href = '<?php echo base_url() ?>admin/category'"
                                class="btn btn-danger pull-right" type="button">Cancelar
                        </button>
                        <button type="submit" id="submit" name="submit" value="Submit"
                                class="btn btn-primary pull-right small-margin">Atualizar categoria
                        </button>
                    </div>
                </div>
